...
parser.add_argument('--mask_path', type=str, default="validation_data_lenses/phase_mask/best_trained_doe_phase_1_PSNR_34.41_freq_96.000GHz_batch_8_layers_2_epochs_3_lr_0.010_dist_doe_0.100_dist_target_0.200_doe_shape_128x128.bmp", help='Path to the phase mask image (.bmp)')
