...
output_folder = Path("/workspace/CD2NN-for-THz/cd2nn_working_fft/stl_models")
output_folder.mkdir(exist_ok=True)  # Create the folder if it doesn't exist

# Iterate over all BMP files in the folder
for bmp_file in Path("/workspace/CD2NN-for-THz/cd2nn_working_fft/best_doe_masks").glob("*.bmp"):
